public class Board {
	...
	private boolean validMove(int xi, int yi, int xf, int yf) {
		System.out.println("\n Inside of validMove : xi and yi: " + (xi) + " " + (yi) + "xf and yf: " + (xf) + " " + (yf));
		if (this.pieceAt(xf, yf) != null) {
			System.out.println("hitttt validMove - piece at final xf ys is not null");
			return false;
		}
		...
		System.out.println("About to begin tests for validMove: ");
	...
	public void select(int x, int y) {
		...
		if (this.gamePieces[x][y] == null) {
			System.out.println("check if select to an empty space works");
			this.currentPiece.move(x, y);
			this.pieceMoved = true;
		}
		System.out.println("this selects the piece and updates x and y in Board: ");
	...
	public boolean canEndTurn() {
		...
		// 	return true;
		// }
		System.out.println("\nInside of canEndturn : ");
		if (this.currentPiece == null) {
			System.out.println("the current piece is null");
			return false;
		}
		else if (this.pieceMoved || this.currentPiece.hasCaptured()) {
			System.out.println("the turn is finished for the current piece has captured");
			return true;
		}
		else {
			System.out.println("default to false");
			return false;
		}
	}

	public void endTurn() {
		System.out.println("Begin endTurn method: ");
